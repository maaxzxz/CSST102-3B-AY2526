...
-- The Decision Tree model worked better than the Linear Regression model. It was able to understand the data in a more flexible way, which helped it make better predictions about house prices.

*   **What were the challenges you encountered?**

-- Some challenges I encountered were making sure the models learned from the data well without getting too specific to the training data (overfitting). I also had to prepare the data carefully so the models could work properly. And nderstanding what each model was focusing on to make predictions took some careful thinking.
"""
